    ...
    >
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto bg-black/50 backdrop-blur">
        <div className="flex min-h-full items-center justify-center p-4">
          <DialogPanel
            transition
            className="gap-5 flex flex-col justify-center items-center w-full max-w-2xl h-[250px] shadow-xl border border-white/50 rounded-xl bg-white/80 backdrop-blur-xl p-6  duration-300 ease-out data-[closed]:transform-[scale(95%)] data-[closed]:opacity-0"
          >
            <DialogTitle
              as="h3"
